...
cd "g:/project/tcltk" ;#工作目录，notes.tcl与notes.db所在的文件夹。
...
proc initial {} {
    ...
    wm title . "$tt pipi.notes windows ver 1.0"
...
proc search {} {
	...
	#set x [db eval "select * from notes \
								     where notesname like '%$et%' OR notesneirong like '%$et%' "]
